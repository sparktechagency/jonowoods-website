      ...
      <div className="relative">
        ...
        >
          {data?.map((classItem, index) => {
            // Fix image URL
            const imageUrl = classItem.thumbnailUrl?.startsWith('http')
              ? classItem.thumbnailUrl
              : `https://${classItem.thumbnailUrl}`;

            return (
              <div
                key={classItem._id || index}
                onClick={() => router.push(`/categories/courses/video/${classItem._id}`)}
...
export default CourseVideoSilder;