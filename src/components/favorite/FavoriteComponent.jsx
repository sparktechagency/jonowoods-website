...
export default function FavoriteComponents() {
  ...
  const [favorite, { isLoading: isFavoriteLoading }] =
      ...
      <div className="grid grid-cols-1 gap-6">
        {favoriteVideos.length > 0 ? (
          favoriteVideos.map(
            (favorite) =>
              isValidVideo(favorite) && (
                ...
                >
                  {/* Left Side - Thumbnail */}
                  <div className="w-full md:w-2/5 h-56 sm:h-64 md:h-80 relative rounded-lg">
                    {favorite.videoId.thumbnailUrl ? (
                      <Image
                        ...
                        alt={
                          favorite.videoId.title || "favorite video thumbnail"
                        }
                        height={200}
                        width={300}
                    ...
                    <div className="border rounded-xl p-4 mb-4">
                      ...
                      {favorite.videoId.description ? (
                        <p className="text-xs text-gray-700">
                          {favorite.videoId.description.length > 800
                            ? favorite.videoId.description.slice(0, 800) + "..."
                            : favorite.videoId.description}
                        </p>
                      ) : (
                    ...
                    <div className="md:hidden flex justify-between items-center w-full mt-2">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          onClick={() =>
                            router.push(
                              `/categories/class/${favorite.videoId._id}`
                            )
                          }
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mt-2">
              You haven't added any videos to your favorites. Start exploring
              and add some!
            </p>
            <Link href="/explore">
