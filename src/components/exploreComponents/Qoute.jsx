...
export default function YogaQuotePage() {
  ...
  const defaultQuote = "Yoga Is The Journey Of The Self, Through The Self, To The Self.";

  if (isLoading) {
    return (
      <div className="bg-white sm:h-[300px] h-[150px] w-full flex items-center justify-center px-2 sm:px-4 md:px-6 lg:px-8">
  ...
  const isFallback = data?.data?.isFallback;
